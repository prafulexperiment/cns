...
unsignedchar aes_key[] = "0123456789abcdef"; 
...
int main() { 
   unsignedchar plaintext[] = "welcome to ISE"; 
   unsignedchar ciphertext[AES_BLOCK_SIZE]; // AES block size is 128 bits 
   unsignedchar decryptedtext[AES_BLOCK_SIZE]; 
